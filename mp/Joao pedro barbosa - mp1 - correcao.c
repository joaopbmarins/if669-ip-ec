...
int main(){
    ...
    if(n>=15){
        ...
        for(int i=0;i<QTD_MAX_PALAVRA;i++){
            scanf("%s", lista_palavra[i]); //faltou o espaço antes do %s
        ...
        for(int k=0;k<qtd_palavra;k++){
            posi_i = rand() % (n - strlen(lista_palavra[0])); //era pra ser lista_palavra[k]
            posi_j = rand() % (n - strlen(lista_palavra[0])); //mesma coisa aqui
            sentindo_escolhido = rand() % 8;

            while(matriz[posi_i][posi_j] != lista_palavra[k][0]){ //loop desnecessário
                
                if(matriz[posi_i][posi_j] == '\0'){
                    int final_palavra;
                    final_palavra = strlen(lista_palavra[k]);
                    if(sentindo_escolhido == 0){
                        if(posi_j + final_palavra<n) //era pra ser posi_j + final_palavra - 1
                        ...
                        if(posi_i + final_palavra<n && posi_j + final_palavra<n) //faltou o -1 aqui tb
                            matriz[posi_i][posi_j] = lista_palavra[k][0];
                        else{
                            strcpy(lista_palavra[k],"\0");
                            break;
                        ...
                        if(posi_i + final_palavra<n) //faltou o -1 aqui tb
                            matriz[posi_i][posi_j] = lista_palavra[k][0];
                        else{
                            strcpy(lista_palavra[k],"\0");
                            break;
                        ...
                        if(posi_i + final_palavra<n && posi_j+1-final_palavra>=0) //faltou o -1 aqui tb
                            matriz[posi_i][posi_j] = lista_palavra[k][0];
                        else{
                            strcpy(lista_palavra[k],"\0");
                            break;
                        ...
                        if(posi_i+1-final_palavra>=0 && posi_j+final_palavra<n) //faltou o -1 aqui tb
                            matriz[posi_i][posi_j] = lista_palavra[k][0];
                        else{
                            strcpy(lista_palavra[k],"\0");
                            break;
